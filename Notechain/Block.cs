...
namespace Notechain
{
    ...
    public class Block
    {
        ...
        /// <summary>
        /// Sets target amount of hash trailing zero bits.
        /// </summary>
        ...
        public Block(Guid id, uint height, byte[] data, string comment,
            byte[] hash, DateTime timestamp, ulong nonce, int difficulty)
        {
            Id = id;
            Height = height;
            Data = data;
        ...
        public static Block? GenerateNew(Entry entry, Block? previousBlock)
        {
            ...
            // Hash target.
            var target = GetHashTarget(entry.Difficulty);
            ...
            for (int i = 0; i < tasksCount; i++)
            {
                ...
                tasks[i] = Task.Run(() =>
                {
                    ...
                    while (localNonce < endNonce)
                    {
                        ...
                        // Return block if it was generated by other task.
        ...
        public static Block? FromStream(Stream stream, Block? previousBlock)
        {
            ...
            buffer = new byte[4];
            stream.Read(buffer);
            int difficulty = BitConverter.ToInt32(buffer);
        ...
        public void WriteBlockToStream(Stream stream)
        {
            ...
            // Difficulty
            stream.Write(BitConverter.GetBytes(Difficulty));
        ...
        /// <summary>
        /// Returns <see langword="true"></see> if <paramref name="hash"/> more than
        /// <paramref name="target"/>, otherwise <see langword="false"></see>.
        /// </summary>
        public static bool IsHashValid(ReadOnlySpan<byte> hash, BigInteger target)
        {
            var hashInt = new BigInteger(hash, true);
